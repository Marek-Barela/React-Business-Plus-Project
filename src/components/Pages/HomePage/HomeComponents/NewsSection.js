    ...
    return(
        <section className='news__section--home'>
            <div className='news__container container'>
                <div className='row'>
                    <div className='col-12 news__column-12'>
                    ...
                    <div className='col-6'>
                        ...
                        <article className='news__article--right'>
                            ...
                            <p className='article__paragraph'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled...</p>
                        </article>
                        <Link to='/News'><button className='btn section__button news__button'>read more</button></Link>
                    </div>
                </div>
            </div>
        </section>
